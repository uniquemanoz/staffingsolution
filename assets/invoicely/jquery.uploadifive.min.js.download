        ...
        init: function(c) {
            return this.each(function() {
                ...
                if (window.File && window.FileList && window.Blob && (window.FileReader || window.FormData)) {
                    ...
                    if (f.dnd) {
						// changed by Paul on 28/08 according to 
						// http://www.uploadify.com/forum/#/discussion/9421/defining-different-dnd-zone-from-queue-container/p1 
						// info: b(f.dropTarget) is dropTarget element
                        var h = f.dropTarget ? b(f.dropTarget).get(0) : d.queueEl.get(0);
                        h.addEventListener("dragleave", function(j) {
                            j.preventDefault();
                            j.stopPropagation();
							b(f.dropTarget).removeClass("dragover-active");
                        }, false);
                        h.addEventListener("dragenter", function(j) {
                            j.preventDefault();
                            j.stopPropagation();
							b(f.dropTarget).addClass("dragover-active");
                        }, false);
						...
						/* start
						** added the below eventListener in order to remove  
						** dragover-active class when drop is done */
                        h.addEventListener("drop", function(j) {
                            j.preventDefault();
                            j.stopPropagation();
							b(f.dropTarget).removeClass("dragover-active");
                        }, false);
