                ...
                <div class="box-body no-padding">
                  ...
                  <div class="table-responsive mailbox-messages">
                    <table class="table table-hover table-striped">
                      <tbody>
                          <?php if($inboxes){ foreach ($inboxes as $overview) { ?>
                        <tr>
                          ...
                          <td><?php   if( !$overview->seen ){ ?> <small class="label pull-right bg-red">New</small>  <?php  }?>     </td>
                          <td class="mailbox-name"><a href="<?php  echo site_url('admin/messageBody').'/'.$overview->msgno;  ?>"><?php  echo $overview->from;  ?></a></td>
                          <td class="mailbox-subject"><b><?php  echo $overview->subject;  ?></b>-Click to view the mail </td>
                          <td class="mailbox-date"><?php  echo $overview->date;  ?></td>
