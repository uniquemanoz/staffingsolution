        ...
        function save()
             {
                 ...
                 //var me ='<?php echo base_url('assets').'/ckeditor/lang/Nepali/fontasy' ?>';
                
                 
                    $.post('<?php echo site_url('admin/about_us') ?>',
                 {
                 ...
                 function(data){
                     if(data=="success")
                     {
                       ...
                       window.location.href = '<?php echo site_url('admin/about_us')?>';
